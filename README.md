...
- 🧮 Обожаю заниматься математикой и у меня есть несколько репозиториев, посвящённых этой теме, где я делюсь своими находками и решениями.
...
- **[Математические репозитории](https://github.com/Elina117?tab=repositories)**  (перейди по ссылке, чтобы посмотреть)
